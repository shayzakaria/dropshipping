    ...
    <div className="mx-auto max-w-3xl">
      ...
      <Card>
        <p className="text-sm font-medium leading-relaxed">
          הנקודה שהכי מבלבלת: <strong>העסק לא מחלק קודים.</strong> העסק פותח קמפיין,
          וכל משפיען שמצטרף מקבל <strong>קוד משלו, אוטומטית</strong> — קוד שאף אחד אחר
          לא מחזיק.
        </p>
          ...
          {[
            {
              ...
              who: "העסק",
              t: "פותח קמפיין",
              d: "בוחר כמה הנחה לתת לקונה וכמה עמלה למשפיען. אלה המספרים שלו — לא שלנו — ואפשר לשנות אותם מקמפיין לקמפיין.",
            },
            {
              n: 2,
              who: "המשפיען",
              t: "מצטרף בלחיצה",
              d: "רואה את הקמפיין ברשימה, רואה בדיוק כמה הוא ירוויח, ומצטרף. ברגע הזה המערכת מייצרת לו קוד אישי.",
            },
            {
              n: 3,
              who: "המשפיען",
