...
const PAGES = ["/", "/login", "/campaigns", "/simulate", "/campaigns/new", "/dashboard", "/businesses", "/admin", "/admin/users", "/legal/accessibility", "/legal/terms", "/legal/privacy", "/legal/influencer"];
