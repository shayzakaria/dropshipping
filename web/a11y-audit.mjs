...
const PAGES = ["/", "/login", "/campaigns", "/simulate", "/campaigns/new", "/dashboard", "/businesses", "/admin", "/admin/users", "/admin/preview", "/legal/accessibility", "/legal/terms", "/legal/privacy", "/legal/influencer"];
