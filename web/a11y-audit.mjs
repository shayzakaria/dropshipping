...
const PAGES = ["/", "/login", "/reset", "/reset/new", "/campaigns", "/simulate", "/campaigns/new", "/dashboard", "/businesses", "/admin", "/admin/users", "/admin/preview", "/admin/payouts", "/how-it-works", "/legal/money", "/legal/accessibility", "/legal/terms", "/legal/privacy", "/legal/influencer"];
